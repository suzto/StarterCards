...
__Need more complex design changes?__ Use the Microsoft Teams UI Kit to modify or build on this design <a href="assets/design_spec.png">(detailed spec)</a> before coding.<br />
